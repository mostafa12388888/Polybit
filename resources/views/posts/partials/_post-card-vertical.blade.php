<x-link href="#" class="group flex-grow flex flex-col text-start !p-0 bg-white dark:bg-dark-700/70 dark:shadow-none overflow-hidden !rounded-md" :href="route('posts.show', str()->slug(fake()->sentence(3)))">
    <div class="relative">
