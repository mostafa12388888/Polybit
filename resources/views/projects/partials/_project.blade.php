<x-link href="{{ route('projects.show', str()->slug(fake()->sentence(4))) }}" class="group flex flex-col text-start !p-0 bg-white dark:bg-dark-700/70 dark:shadow-none shadow !rounded-md overflow-hidden w-full">
    <div class="relative">
