<div class="bg-white dark:bg-dark-600/40 px-4 sm:px-6 py-16 md:py-24 xl:py-36 relative">
    ...
    <div class="container mx-auto flex flex-col gap-3 md:gap-4 lg:gap-8 justify-center items-center flex-wrap text-center relative z-10">
        ...
        <div class="flex flex-wrap w-full flex-grow mt-10 gap-4 lg:gap-6 xl:gap-8">
            <div class="feature w-min min-w-full sm:min-w-80 flex flex-col items-center px-8 py-12 flex-grow rounded-xl ltr:bg-gradient-to-bl rtl:bg-gradient-to-br from-primary-100/60 to-primary-200/80 dark:from-dark-700/50 dark:to-dark-700/80 relative hover:-translate-y-1 hover:scale-105 transition-transform">
                <span class="icon transition-colors bg-white/70 dark:bg-dark-700/70 flex items-center justify-center h-16 w-16 xl:h-20 xl:w-20 rounded-full mb-4 xl:mb-8">
