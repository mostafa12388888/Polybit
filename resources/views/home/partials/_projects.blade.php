<div class="bg-white dark:bg-dark-600/40 px-4 sm:px-6 py-16 md:py-20 xl:py-28 relative">
    <div class="container mx-auto flex flex-col gap-3 md:gap-4 lg:gap-8 justify-center items-center flex-wrap text-center relative z-10">
        <h2 class="text-primary-800 dark:text-dark-100 text-2xl lg:text-3xl xl:text-[2.5rem] font-extrabold relative px-8 z-50">{{ __('Featured Projects') }}</h2>
