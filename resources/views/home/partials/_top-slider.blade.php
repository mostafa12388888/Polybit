            ...
            <li class="glide__slide h-full relative">
                <div class="w-full h-full">
                    @if ($slide->title || $slide->description || $slide->actions)
                        ...
                        <x-curator-glider :media="$slide->image" format="webp" width="720" height="240" fit="fill" bg="FFFFFF" quality="30" class="w-full h-full object-cover" :alt="$slide->title" />
                    @else
                        <x-curator-glider :media="$slide->image" format="webp" width="1280" height="480" fit="fill" bg="FFFFFF" quality="70" class="w-full h-full object-cover" :alt="config('app.name')" />
                    @endif
