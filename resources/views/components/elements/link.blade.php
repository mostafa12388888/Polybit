...
@php
    ...
    switch ($styling) {
        case 'light-link':
            ...
            break;
        case 'light':
            $classes .= " bg-gray-100 dark:bg-dark-700 hover:brightness-95 focus:brightness-95 active:brightness-95";
            break;
        case 'white':
            $classes .= " bg-white dark:bg-dark-700 hover:bg-gray-50 dark:bg-dark-700 dark:hover:brightness-95 focus:bg-gray-50 dark:focus:brightness-95 active:bg-gray-200 dark:active:brightness-95 shadow-sm";
            break;
        case 'primary':
