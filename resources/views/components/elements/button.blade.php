...
@php
    ...
    switch ($styling) {
        case 'light-link':
            ...
            break;
        case 'light':
            $classes .= " bg-secondary-100 dark:bg-dark-700 hover:brightness-95 focus:brightness-95 active:brightness-90";
            break;
        case 'white':
            $classes .= " bg-white dark:bg-dark-700 hover:bg-secondary-50 dark:bg-dark-700 dark:hover:brightness-95 focus:bg-secondary-50 dark:focus:brightness-95 active:bg-secondary-100 dark:active:brightness-90 shadow-sm";
            break;
        case 'primary':
            ...
            break;
        case 'secondary':
            $classes .= " text-white hover:text-white focus:text-white active:text-white bg-secondary-500 hover:bg-secondary-600 focus:bg-secondary-600 active:bg-secondary-700";
            break;
        case 'danger':
