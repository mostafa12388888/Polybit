...
<x-link x-init="setTimeout(() => {$el.classList.remove('opacity-0');}, 1000);" 
    ...
    class="opacity-0 transition-opacity duration-700 fixed bottom-20 sm:bottom-4 rtl:left-4 ltr:right-4 !rounded-full w-14 h-14 sm:w-16 sm:h-16 bg-[#25D366] flex justify-center items-center border-2 border-dark-100">
