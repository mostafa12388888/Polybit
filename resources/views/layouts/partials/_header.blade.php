<header class="sticky top-0 bg-white dark:bg-dark-700" x-ref="header">
    ...
    <div class="bg-white dark:bg-dark-800/70 shadow mx-auto px-2 py-3 relative">
        <div class="container mx-auto flex gap-3 sm:gap-4 lg:gap-6 justify-between items-center flex-wrap">
            @include('layouts.partials._navbar')            
            
            <div class="flex flex-row-reverse gap-2 md:gap-2.5 flex-grow xl:flex-grow-0 order-2 items-center">
                @include('layouts.partials._user-menu')            
                
                <x-button styling="light" class="!rounded-xl aspect-square w-11 h-11 !p-0 flex items-center justify-center" @click="toggleDarkMode">
