            ...
            <div class="bg-white dark:bg-dark-700/60 px-4 py-8 md:px-6 lg:py-0 xl:px-8 sm:rounded-md dark:border-dark-700 flex flex-col gap-6 lg:table w-full xl:w-8/12 2xl:w-9/12">
                ...
                @foreach (range(1, rand(3, 7)) as $item)
                    <div class="flex lg:table-row gap-2 sm:gap-4 items-center justify-between">
                        <div class="table-cell align-middle lg:pt-6 lg:pb-6 lg:border-t border-dashed border-dark-200/70 dark:border-dark-700 shrink-0">
                            <img src="{{ asset('/storage/product1.webp') }}" class="w-16 h-16 sm:w-20 sm:h-20 rounded-md" alt="">
                        </div>
                        
                        <div class="table-cell align-middle lg:pt-6 lg:pb-6 lg:border-t border-dashed border-dark-200/70 dark:border-dark-700 flex-grow">
                            <h3>{{ fake()->sentence(5) }}</h3>
                        </div>
