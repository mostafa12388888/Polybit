...
@else
    <section class="flex-grow bg-secondary-100/50 dark:bg-dark-800/70 lg:py-6 xl:py-8">
        <div class="lg:container mx-auto flex flex-col lg:flex-row lg:gap-4">
            ...
            <form wire:submit="request_catalog" class="lg:rounded-md flex-grow w-full overflow-hidden order-2 bg-white dark:bg-dark-700/60 py-8 px-4 md:px-6 xl:px-8 flex flex-col gap-6">
