    ...
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        <div class="flex justify-between flex-1 sm:hidden">
            @if ($paginator->onFirstPage())
                <span class="relative inline-flex items-center px-5 py-3 text-sm font-medium text-gray-400 bg-white border border-gray-100 cursor-default leading-5 rounded-md dark:text-gray-500 dark:bg-zinc-700 dark:border-zinc-600/50">
            ...
            @else
                <span class="relative inline-flex items-center px-5 py-3 ms-3 text-sm font-medium text-gray-400 bg-white border border-gray-100 cursor-default leading-5 rounded-md dark:text-gray-500 dark:bg-zinc-700 dark:border-zinc-600/50">
                    {!! __('pagination.next') !!}
                </span>
            @endif
        </div>
