        ...
        @if (count($containers) || $emptyLabel !== false)
            <div class="table-repeater-container rounded-xl relative ring-1 ring-gray-950/5 dark:ring-white/20">
                <table class="w-full">
                    ...
                    <tr class="text-xs md:divide-x md:divide-gray-950/5 dark:md:divide-white/20 rtl:divide-x-reverse">
                        ...
                        @if ($hasActions && count($containers))
                            <th class="table-repeater-header-column w-px ltr:last:rounded-tr-xl rtl:last:rounded-tl-xl p-2 bg-gray-100 dark:bg-gray-900/60">
                                <span class="sr-only">
                    ...
                    @if (count($containers))
                        @foreach ($containers as $uuid => $row)
                            ...
                            <tr
                                ...
                                class="table-repeater-row rtl:!divide-x-reverse"
                            >
                                @php($counter = 0)
