        ...
        return $table
            ->columns([
                ...
                TextColumn::make('users_count')
                    ->counts('users')
                    ->label(__('filament-spatie-roles-permissions::filament-spatie.field.users_count'))
    ...
    public static function infolist(Infolist $infolist): Infolist
    {
        return $infolist->schema([
            \Filament\Infolists\Components\Section::make()->schema([
                ...
                TextEntry::make('permissions.name')->columnSpanFull()->badge()
                    ->label(__('filament-spatie-roles-permissions::filament-spatie.section.permissions')),
            ])->columns(2),
        ]);
    }
